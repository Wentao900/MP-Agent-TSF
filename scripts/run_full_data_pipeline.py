...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "One-shot Scheme C data pipeline: crawl announcements -> fetch files -> build price/text -> validate. "
            "For resilient batch download and auto-resume, prefer scripts/auto_fetch_all.py"
        )
    )
